...
from lib.openapi_client.api_client import ApiClient, Endpoint as _Endpoint
from lib.openapi_client.model_utils import (  # noqa: F401
...
class FileuploadApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.pcssuperfile2_endpoint = _Endpoint(
            settings={'response_type': (dict,),
                      'auth': [],
                      'endpoint_path': '/rest/2.0/pcs/superfile2?method=upload&openapi=xpansdk',
                      'operation_id': 'pcssuperfile2',
                      'http_method': 'POST',
                      'servers': [{'url': "https://d.pcs.baidu.com",
                                   'description': "No description provided", }, ]},
            params_map={'all': ['access_token', 'partseq', 'path', 'uploadid', 'type', 'file', ],
                        'required': ['access_token', 'partseq', 'path', 'uploadid', 'type', ],
                        'nullable': [],
                        'enum': [],
                        'validation': []},
            root_map={'validations': {},
                      'allowed_values': {},
                      'openapi_types': {'access_token': (str,),
                                        'partseq': (str,),
                                        'path': (str,),
                                        'uploadid': (str,),
                                        'type': (str,),
                      ...
                      'attribute_map': {'access_token': 'access_token',
                                        ...
                                        'type': 'type',
                                        'file': 'file', },
                      'location_map': {'access_token': 'query',
                                       'partseq': 'query',
                                       'path': 'query',
                                       'uploadid': 'query',
                                       'type': 'query',
            ...
            headers_map={'accept': ['text/html;charset=utf8'],
                         'content_type': ['multipart/form-data']},
            api_client=api_client)
        self.xpanfilecreate_endpoint = _Endpoint(settings={'response_type': (dict,),
                                                           'auth': [],
                                                           'endpoint_path': '/rest/2.0/xpan/file?method=create&openapi=xpansdk',
                                                           'operation_id': 'xpanfilecreate',
                                                           'http_method': 'POST',
                                                           'servers': [{'url': "https://pan.baidu.com",
                                                                        'description': "No description provided", }, ]},
                                                 params_map={'all': ['access_token',
                                                                     'path',
                                                                     'isdir',
                                                                     'size',
                                                                     'uploadid',
                                                 ...
                                                 api_client=api_client)
        self.xpanfileprecreate_endpoint = _Endpoint(settings={'response_type': (dict,),
                                                              'auth': [],
                                                              ...
                                                              'servers': [{'url': "https://pan.baidu.com",
                                                                           'description': "No description provided", }, ]},
                                                    params_map={
                                                        'all': ['access_token', 'path', 'isdir', 'size', 'autoinit',
                                                                'block_list', 'rtype'],
                                                        'required': ['access_token', 'path', 'isdir', 'size',
                                                                     'autoinit', 'block_list', ],
                                                        'nullable': [],
                                                        'enum': [],
                                                        'validation': []},
    ...
    def xpanfilecreate(self, access_token, path, isdir, size, uploadid, block_list, **kwargs):
    ...
    def xpanfileprecreate(self, access_token, path, isdir, size, autoinit, block_list, **kwargs):
        """xpanfileprecreate  # noqa: E501

        文件预上传，用于获取上传任务id，即uploadid

        >>> thread = api.xpanfileprecreate(access_token, path, isdir, size, autoinit, block_list, async_req=True)
        >>> result = thread.get()

        Args:
            access_token (str): 用户的 Access Token
