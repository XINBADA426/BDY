...
from lib.openapi_client import rest
from lib.openapi_client.configuration import Configuration
from lib.openapi_client.exceptions import ApiTypeError, ApiValueError, ApiException
from lib.openapi_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
    ...
    def call_with_http_info(self, **kwargs):
        ...
        for key, value in kwargs.items():
            if key not in self.params_map['all']:
                raise ApiTypeError(f"Got an unexpected parameter `{key}` to method `{self.settings['operation_id']}`")
